  ...
  Widget build(BuildContext context) {
    ...
    return Row(
        ...
        children: [
          ...
          Text(widget.label, style: widget.readOnly ? AppTextStyle.formReadOnlyLabelStyle : AppTextStyle.formLabelStyle),
              ...
              child: Stack(
                ...
                children: [
                  TextField(
                    ...
                    style: widget.readOnly ? AppTextStyle.formReadOnlyValueStyle : AppTextStyle.formValueStyle,
                    maxLines: null,
